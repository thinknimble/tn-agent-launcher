...
SERVER_EMAIL = config("DEFAULT_FROM_EMAIL", default="tn-agent-launcher <noreply@tn_agent_launcher.com>")
...
#
HEROKU_APP_NAME = config("HEROKU_APP_NAME", default="tn_agent_launcher-staging")
...
ROOT_URLCONF = "tn_agent_launcher.urls"
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(
                BASE_DIR, "tn_agent_launcher", "client", "templates"
...
ASGI_APPLICATION = "tn_agent_launcher.asgi.application"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "tn_agent_launcher.core.pagination.PageNumberPagination",
...
if config("USE_AWS_STORAGE", cast=bool, default=False):
    ...
    DEFAULT_FILE_STORAGE = "tn_agent_launcher.utils.storages.PrivateMediaStorage"
    # STATICFILES_STORAGE = "tn_agent_launcher.utils.storages.StaticRootS3Boto3Storage"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "tn_agent_launcher.request": {"handlers": [], "level": "INFO", "propagate": True},
        "tn_agent_launcher.tasks": {"handlers": [], "level": "INFO", "propagate": True},
    },
}
...
if IN_PROD or ROLLBAR_ACCESS_TOKEN:
    ...
    LOGGING["loggers"]["tn_agent_launcher"]["handlers"].append("rollbar")

...
class ExecutionManager:
    ...
    def _process_results(self, task: Any, execution: Any, result: Any, start_time: datetime) -> None:
    ...
    def _handle_execution_error(self, task: Any, execution: Any, start_time: datetime, error: Exception) -> None:

...
class InputSourceProcessor:
    ...
    def _process_single_source(self, source: Any) -> Dict[str, Any]:
        ...
        url, source_type, filename, content_type, size, processing_config = self._extract_source_metadata(source)
    ...
    def _extract_source_metadata(self, source: Any) -> tuple:
        ...
        if isinstance(source, dict):
            ...
            processing_config = {
                ...
                "replace_images_with_descriptions": source.get("replace_images_with_descriptions", True),
    ...
    def create_enhanced_instruction(self, base_instruction: str, input_sources_content: List[Dict]) -> str:

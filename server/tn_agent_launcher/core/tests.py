...
class TestEmailValidation:
    ...
    @mock.patch("tn_agent_launcher.core.serializers.logger")
    @mock.patch("tn_agent_launcher.core.serializers.rollbar")
...
class TestPreviewTemplateView:
    ...
    def test_enabled_if_debug(self, client):
        with mock.patch("tn_agent_launcher.core.views.render", return_value=Response()) as mocked_render:
    ...
    def test_parse_value_with_model(self):
        with mock.patch("tn_agent_launcher.core.views.apps") as mock_apps:
